...
def adjust_sleep_data_to_mnist(data, to_image_dim=20):
    """
    Reshape: tensor.Size(batch_size, 1, sleep_epoch=3000) to tensor.Size(batch_size, 1, 20, 150)
    Args:
    ...
    data = torch.reshape(data, (data.shape[0], data.shape[1], to_image_dim, int(data.shape[3] / to_image_dim)))
